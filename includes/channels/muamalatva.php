 ...
 */
class Muamalatva extends Payment_Method
{
    ...
    public function __construct()
    {
        ...
        $this->id            = 'tripay-MUAMALATVA';
        $this->name          = 'Tripay Muamalat VA';
        $this->icon_id       = SALESLOO_TRIPAY_URL . '/assets/images/muamalatva.png';;
        $this->title         = 'Muamalat Virtual Account';
